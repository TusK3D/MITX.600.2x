...
class RectangularRoom(object):
    ...
    def getNumTiles(self):
        ...
        returns: an integer
        """
        return sum([len(x) for x in self.tiles])
    ...
    def getRandomPosition(self):
        ...
        """
        return Position(random.random() * self._width, 
                        random.random() * self._height)
    ...
    def isPositionInRoom(self, pos):
        ...
        """
        return pos.getX() >= 0.0 and pos.getX() < (self._width) and \
            pos.getY() >= 0.0 and pos.getY() < (self._height) 
...
class Robot(object):
    ...
    def setRobotDirection(self, direction):
        ...
        if direction >= 0 and direction <= 360:
            ...
            raise ValueError("Direction not in Degress(0-360)")
...
class StandardRobot(Robot):
    ...
    def updatePositionAndClean(self):
        ...
        """
        #while True:
        newPos = self._position.getNewPosition(self._direction, self._speed)
        if self._room.isPositionInRoom(newPos):
            self._position = newPos
            self._room.cleanTileAtPosition(newPos)
        #    break
        else:
...
def runSimulation(num_robots, speed, width, height, min_coverage, num_trials,
    ...
    steps = [0 for x in range(num_trials)]
...
print(runSimulation(1, 1.0, 16, 16, 0.8, 1, RandomWalkRobot))
print(runSimulation(1, 1.0, 16, 16, 0.8, 1, StandardRobot))
